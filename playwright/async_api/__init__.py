...
class Expect:
    ...
    def poll(
        ...
        *,
        ...
        Args:
            callback: Function returning the value to assert. Can be async.
        ...
        Example:
            ...
            await expect.poll(get_value, timeout=3000).to_be_greater_than_or_equal(3)
            await expect.poll(lambda: page.title()).to_match("Example")
            ```
        """
